...
var displayThings = [
	...
	function(){return `当前endgame:约e70000点数,e315000增量点,1e215pp,7.5e10高德纳箭头点.`},
]

// Determines when the game "ends"
function isEndgame() {
	return player.points.gte("1e70000")&&player.i.points.gte("1e315000")&&player.p.points.gte(1e215)&&player.a.points.gte(7.5e10)
}
